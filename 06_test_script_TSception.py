# -*- coding: utf-8 -*-
"""Runs cross-validation, hyperparameter selection, and testing for TSception
...
evaluation for the TSception model family.
"""
...
from models.TSception_model import TSception_Full
...
if model_cls.__name__ == "TSception_Full":
...
# Define the electrodes usedin TSception
electrode_dict = {
...
model_params = {'all_electrodes_list': [electrode_list],
...
optimizer_params ={"lr": [1e-2, 1e-3],"weight_decay":[0, 1e-2]} #grid search
