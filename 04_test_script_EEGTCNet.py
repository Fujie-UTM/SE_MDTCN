# -*- coding: utf-8 -*-
"""Runs cross-validation, hyperparameter selection, and testing for EEGTCNet
...
evaluation for the EEGTCNet model family.
"""
...
from models.EEGTCNet_model import EEGTCNet
...
if model_cls.__name__ == "EEGTCNet":
