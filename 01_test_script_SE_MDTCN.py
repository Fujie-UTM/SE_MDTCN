# -*- coding: utf-8 -*-
"""Runs cross-validation, hyperparameter selection, and testing for SE-MDTCN.
...
evaluation for the SE-MDTCN model family.
"""
...
# Import SE-MDTCN model variants.
from models.SE_MDTCN_model import (
    SE_MDTCN,
    SE_MDTCN_woElectrodeNormalization,
    SE_MDTCN_woSpatialFilter,
    SE_MDTCN_woTemporalFilter,
...
if model_cls.__name__ == "SE_MDTCN_wZScoreNormalization":
...
# Define temporal TCN branch configurations.
branch_params = [
